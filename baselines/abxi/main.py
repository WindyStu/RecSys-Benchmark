...
def main() -> None:
    ...
    parser.add_argument('--data_root', type=str, default=None, help='optional root directory containing dataset folders')
    parser.add_argument('--sample_eval', action='store_true', help='use sampled evaluation with --n_mtc negatives')
    ...
    args.full_eval = not args.sample_eval
    args.path_data = join(args.data_root if args.data_root else join(args.path_root, 'data'), args.data)
