...
class Noter(object):
    ...
    def log_valid(self,
        ...
        msg = (f'           | val |     | '
               f'{res_a[0]:.4f} | {res_a[1]:.4f} | {res_a[2]:.4f} | {res_a[3]:.4f} | {res_a[4]:.4f} | '
               f'{res_b[0]:.4f} | {res_b[1]:.4f} | {res_b[2]:.4f} | {res_b[3]:.4f} | {res_b[4]:.4f} |')
        self.log_msg(msg)
    ...
    def log_test(self,
        ...
        msg = (f'           | te  |  *  | '
               f'{ranks[0][0]:.4f} | {ranks[0][1]:.4f} | {ranks[0][2]:.4f} | {ranks[0][3]:.4f} | {ranks[0][4]:.4f} | '
               f'{ranks[1][0]:.4f} | {ranks[1][1]:.4f} | {ranks[1][2]:.4f} | {ranks[1][3]:.4f} | {ranks[1][4]:.4f} |  *  |')
        self.log_msg(msg)
