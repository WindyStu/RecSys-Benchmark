...
from utils.noter_mt import Noter
...
def main():
    ...
    args.f_data = join(args.path_data, args.data + f'_{args.len_max}_{args.m}_mt_seq.pkl')
    ...
    if args.m == 'sasrec':
        from trainers.trainer_SASRec_mt import Trainer
    elif args.m == 'bert4rec':
        from trainers.trainer_BERT4Rec_mt import Trainer
    elif args.m == 'stosa':
        from trainers.trainer_STOSA_mt import Trainer
    else:
