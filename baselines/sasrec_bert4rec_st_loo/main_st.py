...
from utils.noter_st import Noter
...
def main():
    ...
    parser.add_argument('--eval_mode', type=str, default='full', choices=['full', 'sampled'],
                        help='full ranks against all unobserved items; sampled ranks against n_mtc negatives')
    ...
    args.f_data = join(args.path_data, args.data + f'_{args.len_max}_{args.m}_st_seq.pkl')
    ...
    if args.m == 'sasrec':
        from trainers.trainer_SASRec_st import Trainer
    ...
    for epoch in range(1, args.n_epoch + 1):
        ...
        mrr_val = res_val[-1]  # use mrr as identifier
    ...
    noter.log_final_result(res_test)
