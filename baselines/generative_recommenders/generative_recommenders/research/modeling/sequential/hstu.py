...
def _asynchronous_complete_cumsum(lengths: torch.Tensor) -> torch.Tensor:
    """Convert lengths to jagged tensor offsets (exclusive cumsum + leading zero).

    Equivalent to torch.ops.fbgemm.asynchronous_complete_cumsum.
    Returns shape (B+1,) with values [0, l1, l1+l2, ...].
    """
