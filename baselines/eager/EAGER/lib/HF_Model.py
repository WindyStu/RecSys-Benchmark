...
_transformers_utils.is_torchvision_available = lambda: False
_transformers_import_utils.is_torchvision_available = lambda: False
_transformers_utils.is_torchaudio_available = lambda: False
_transformers_import_utils.is_torchaudio_available = lambda: False
