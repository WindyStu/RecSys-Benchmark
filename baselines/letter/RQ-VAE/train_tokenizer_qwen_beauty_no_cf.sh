...
CKPT_DIR=${CKPT_DIR:-"${REPO_ROOT}/checkpoint/${DATASET}_qwen_letter_no_cf"}
...
LOG_FILE=${LOG_FILE:-"${SCRIPT_DIR}/log/${DATASET}_no_cf_${RUN_TS}.log"}
...
echo "Train LETTER tokenizer ablation without collaborative regularization"
