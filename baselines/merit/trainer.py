...
class Trainer(object):
    ...
    def evaluate_batch(self,
        ...
        seq_m, idx_last_a, idx_last_b, gt, gt_mtc, gt_mtc_mask = map(lambda x: x.to(self.device), batch)

        h_m, h_a, h_b = self.model(seq_m, idx_last_a, idx_last_b)

        ranks, mask_gt_a, mask_gt_b = self.model.cal_rank(h_m, h_a, h_b, gt, gt_mtc, gt_mtc_mask)
