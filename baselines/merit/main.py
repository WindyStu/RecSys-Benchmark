...
def main() -> None:
    ...
    for p in [args.path_data, args.path_log, args.path_ckpt]:
    ...
    for epoch in range(1, args.n_epoch + 1):
        ...
        if epoch <= args.n_warmup:
            ...
            if mrr_val >= mrr_log:
                ...
                ckpt_name = f'{args.data}-{args.len_max}-d{args.d_embed}-seed{args.seed}-best.pth'
                ckpt_path = join(args.path_ckpt, ckpt_name)
                torch.save(trainer.model.state_dict(), ckpt_path)
                noter.log_msg(f'           | ckpt | saved best model to {ckpt_path}')
